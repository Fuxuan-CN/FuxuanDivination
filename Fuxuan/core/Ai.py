...
class Session:
    ...
    def _write_to_stdout(self, content: str | None) -> None:
        """ 输出到控制台 """
        msg = f"\033[1;35m{content}\033[0m"
        sys.stdout.write(msg)
        sys.stdout.flush()
            
    def _send(self, usr_message: str, write_to_stdout: bool = True) -> str:
        ...
        if write_to_stdout and self.stream:
            all_content: str = ""
    ...
    def send(self, usr_message: str) -> str:
        """ 发送消息 """
        return self._send(usr_message)
