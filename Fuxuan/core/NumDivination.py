...
class NumDivination(DivinationAble):
    """数字占卜类"""
    ...
    def build_hexagram(self) -> DivinationResult:
        ...
        result = DivinationResult(div_type=DivType.LUCK, original=orig_hexagram, mutual=mutual_hexagram, changed=changed_hexagram)
        return result
