from ...utils import NUM_TO_HEXGRAM_STR , HEXAGRAM_DESCRIPTION_STR , YANG , YIN, NOW, ZHI_TO_TIME, ZHI_NUM, HEXGRAM_DESCRIPTION, DIZHI, TIANGAN
...
class TimeDivination(DivinationHandlerAble):
    ...
    def get_year_gan(self) -> str:
        """
        获取当前年干
        """
        year_gan = (NOW.year - 4) % 10
        return TIANGAN[year_gan]
