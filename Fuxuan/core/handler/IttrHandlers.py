...
class BaseHandler(InterpretHandler):
    ...
    基础解释器，用于处理未知类型解释器
    """
    def __init__(self, api_key: str = "", type: IttrType = IttrType.NONE) -> None:
...
class LuckHandler(BaseHandler):
    ...
    def __init__(self, api_key: str = "") -> None:
        super().__init__(api_key, IttrType.LUCK)
...
class ItemFoundHandler(BaseHandler):
    """ 寻物占卜处理器 """
    def __init__(self, api_key: str = "") -> None:
        super().__init__(api_key, IttrType.ITEM)
...
class AnotherHandler(BaseHandler):
    """ 其他占卜处理器 """
    def __init__(self, api_key: str = "") -> None:
        super().__init__(api_key, IttrType.ANOTHER)
