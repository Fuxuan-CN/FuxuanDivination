...
from ..model import hexagramType , hexagramsType , DivinationResult , DivType

class TimeDivination(DivinationAble):
    """
    ...
    def build_hexagram(self) -> DivinationResult:
        ...
        result = DivinationResult(div_type=DivType.LUCK, original=original_hexagram, mutual=mutual_hexagram, changed=changed_hexagram)
        return result
